<%-- 
    Document   : index.jsp
    Created on : 26-Feb-2020, 08:06:43
    Author     : Jenny
--%>
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><% if (news.getDescription().trim().length() > 100) {
                                            out.println(news.getDescription().trim().substring(0, 99) + "...");
                                        } else {
                                            out.println(news.getDescription().trim());
                                        } %> </p>
                                </div>
